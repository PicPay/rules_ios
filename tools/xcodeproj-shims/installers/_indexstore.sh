...
readonly bazel_swift_object="$bazel_bin/.*/(.+?)(?:_swift)?(?:[.]library)?_objs/.*/(.+?)[.]swift[.]o$"
readonly bazel_objc_object="$bazel_bin/.*/(?:[.]library)?_objs/(?:arc/|non_arc/)?(.+?)-(?:objc|cpp)/(.+?)[.]o$"
...
$BAZEL_PATH run @com_github_lyft_index_import//:index_import \
